...
function Header({ toggleCart, DIR }) {
    return (
        <div id="Header">
            <div id="header-logo">
                ⦾ NeoTech ⦾
            ...
            <div id="menu">
                <Link className="menu-item" to={`${DIR}/`}>Home</Link>
                <Link className="menu-item" to={`${DIR}/products`}>Products</Link>
                <Link className="menu-item" to={`${DIR}/contacts`}>Contacts</Link>
